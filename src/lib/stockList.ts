...
export const STOCK_LIST: StockInfo[] = [
  ...
  { code: 'LYFT', en: 'Lyft', zh: 'Lyft', sector: '科技', themes: ['共享出行'], blurb: '美国第二大网约车' },
  { code: 'DASH', en: 'DoorDash', zh: 'DoorDash', sector: '科技', themes: [], blurb: '美国最大外卖平台' },
  ...
  { code: 'STX', en: 'Seagate', zh: '希捷', sector: '科技', themes: [], blurb: '机械硬盘巨头之一' },
  { code: 'WDC', en: 'Western Digital', zh: '西数', sector: '科技', themes: [], blurb: '硬盘和闪存（NAND）' },
  { code: 'NTAP', en: 'NetApp', zh: 'NetApp', sector: '科技', themes: ['云计算'], blurb: '企业数据存储' },
  { code: 'ANSS', en: 'Ansys', zh: 'Ansys', sector: '科技', themes: [], blurb: '工程仿真软件' },
  { code: 'ADSK', en: 'Autodesk', zh: 'Autodesk', sector: '科技', themes: [], blurb: 'AutoCAD制图软件' },
  { code: 'KEYS', en: 'Keysight', zh: '是德', sector: '科技', themes: [], blurb: '电子测试测量仪器' },
  { code: 'APP', en: 'AppLovin', zh: 'AppLovin', sector: '科技', themes: ['广告', 'AI'], blurb: '手游广告变现平台，AI投放' },
  { code: 'TTD', en: 'Trade Desk', zh: 'Trade Desk', sector: '科技', themes: ['广告'], blurb: '程序化广告购买平台' },
  { code: 'MGNI', en: 'Magnite', zh: 'Magnite', sector: '科技', themes: ['广告'], blurb: '广告供给端平台' },
  { code: 'TOST', en: 'Toast', zh: 'Toast', sector: '科技', themes: ['金融科技'], blurb: '餐厅点餐收银SaaS' },
  { code: 'BILL', en: 'Bill.com', zh: 'Bill', sector: '科技', themes: ['金融科技'], blurb: '中小企业账款自动化' },
  { code: 'GLOB', en: 'Globant', zh: 'Globant', sector: '科技', themes: [], blurb: '拉美IT外包咨询' },
  { code: 'EPAM', en: 'EPAM', zh: 'EPAM', sector: '科技', themes: [], blurb: '软件外包' },
  ...
  { code: 'MARA', en: 'MARA Holdings', zh: 'MARA', sector: '科技', themes: ['加密'], blurb: '北美大比特币矿企' },
  ...
  { code: 'KLAC', en: 'KLA', zh: 'KLA', sector: '半导体', themes: ['芯片'], blurb: '芯片检测量测设备' },
  { code: 'ASML', en: 'ASML', zh: '阿斯麦', sector: '半导体', themes: ['芯片'], blurb: '光刻机全球唯一，卡脖子那家' },
  { code: 'SNPS', en: 'Synopsys', zh: '新思', sector: '半导体', themes: ['芯片'], blurb: '芯片设计EDA软件' },
  { code: 'CDNS', en: 'Cadence', zh: '铿腾', sector: '半导体', themes: ['芯片'], blurb: '芯片设计EDA软件（铿腾）' },
  { code: 'GFS', en: 'GlobalFoundries', zh: '格芯', sector: '半导体', themes: ['芯片'], blurb: '美国本土芯片代工厂' },
  { code: 'ON', en: 'ON Semiconductor', zh: '安森美', sector: '半导体', themes: ['芯片'], blurb: '功率半导体（电动车和工业）' },
  { code: 'NXPI', en: 'NXP', zh: '恩智浦', sector: '半导体', themes: ['芯片'], blurb: '汽车和物联网芯片' },
  { code: 'TXN', en: 'Texas Instruments', zh: '德州仪器', sector: '半导体', themes: ['芯片'], blurb: '模拟芯片老牌' },
  { code: 'ADI', en: 'Analog Devices', zh: '亚德诺', sector: '半导体', themes: ['芯片'], blurb: '模拟芯片（亚德诺）' },
  { code: 'MPWR', en: 'Monolithic Power', zh: '芯源', sector: '半导体', themes: ['芯片'], blurb: '电源管理芯片' },
  { code: 'TER', en: 'Teradyne', zh: '泰瑞达', sector: '半导体', themes: ['芯片'], blurb: '芯片测试设备' },
  ...
  { code: 'PARA', en: 'Paramount', zh: '派拉蒙', sector: '通信', themes: ['流媒体'], blurb: '派拉蒙影业加CBS' },
  { code: 'EA', en: 'Electronic Arts', zh: 'EA', sector: '通信', themes: ['游戏'], blurb: 'FIFA和战地，体育游戏大厂' },
  { code: 'TTWO', en: 'Take-Two', zh: 'Take-Two', sector: '通信', themes: ['游戏'], blurb: 'GTA母公司' },
  { code: 'RBLX', en: 'Roblox', zh: 'Roblox', sector: '通信', themes: ['游戏'], blurb: '小孩玩的3D沙盒游戏平台' },
  { code: 'SPOT', en: 'Spotify', zh: 'Spotify', sector: '通信', themes: ['流媒体'], blurb: '流媒体音乐龙头' },
  { code: 'ROKU', en: 'Roku', zh: 'Roku', sector: '通信', themes: ['流媒体'], blurb: '电视棒和系统，靠广告赚钱' },
  { code: 'PINS', en: 'Pinterest', zh: 'Pinterest', sector: '通信', themes: ['社交'], blurb: '图片社交，广告变现' },
  ...
  { code: 'NTES', en: 'NetEase', zh: '网易', sector: '通信', themes: ['游戏'], blurb: '网易，游戏加有道' },
  { code: 'IQ', en: 'iQIYI', zh: '爱奇艺', sector: '通信', themes: ['流媒体'], blurb: '爱奇艺，长视频' },
  { code: 'BILI', en: 'Bilibili', zh: '哔哩哔哩', sector: '通信', themes: ['流媒体'], blurb: 'B站，年轻人社区' },
  ...
  { code: 'BAC', en: 'Bank of America', zh: '美国银行', sector: '金融', themes: [], blurb: '美国第二大银行' },
  { code: 'WFC', en: 'Wells Fargo', zh: '富国银行', sector: '金融', themes: [], blurb: '富国银行，房贷见长' },
  { code: 'C', en: 'Citigroup', zh: '花旗', sector: '金融', themes: [], blurb: '花旗，国际业务多' },
  { code: 'GS', en: 'Goldman Sachs', zh: '高盛', sector: '金融', themes: [], blurb: '高盛，投行之王' },
  ...
  { code: 'MA', en: 'Mastercard', zh: '万事达', sector: '金融', themes: ['金融科技'], blurb: '万事达，老二' },
  { code: 'BLK', en: 'BlackRock', zh: '贝莱德', sector: '金融', themes: [], blurb: '全球最大资管（贝莱德），ETF之王' },
  { code: 'SCHW', en: 'Charles Schwab', zh: '嘉信', sector: '金融', themes: [], blurb: '嘉信理财，散户券商' },
  { code: 'COIN', en: 'Coinbase', zh: 'Coinbase', sector: '金融', themes: ['加密'], blurb: '美国最大加密交易所' },
  { code: 'HOOD', en: 'Robinhood', zh: 'Robinhood', sector: '金融', themes: ['金融科技', '加密'], blurb: '零佣金散户券商鼻祖' },
  ...
  { code: 'UPST', en: 'Upstart', zh: 'Upstart', sector: '金融', themes: ['AI', '金融科技'], blurb: 'AI放贷审核' },
  ...
  { code: 'TGT', en: 'Target', zh: '塔吉特', sector: '消费', themes: ['零售'], blurb: '塔吉特，中产超市' },
  ...
  { code: 'SBUX', en: 'Starbucks', zh: '星巴克', sector: '消费', themes: ['餐饮'], blurb: '星巴克' },
  { code: 'NKE', en: 'Nike', zh: '耐克', sector: '消费', themes: ['服装'], blurb: '耐克' },
  { code: 'LULU', en: 'Lululemon', zh: 'Lululemon', sector: '消费', themes: ['服装'], blurb: '瑜伽服，中产衣柜' },
  { code: 'KO', en: 'Coca-Cola', zh: '可口可乐', sector: '消费', themes: ['饮料'], blurb: '可口可乐' },
  { code: 'PEP', en: 'PepsiCo', zh: '百事', sector: '消费', themes: ['饮料'], blurb: '百事可乐加零食（乐事）' },
  { code: 'PG', en: 'Procter & Gamble', zh: '宝洁', sector: '消费', themes: ['日化'], blurb: '宝洁，日化巨头' },
  { code: 'CL', en: 'Colgate', zh: '高露洁', sector: '消费', themes: ['日化'], blurb: '高露洁，牙膏' },
  { code: 'UL', en: 'Unilever', zh: '联合利华', sector: '消费', themes: ['日化'], blurb: '联合利华，日化食品' },
  { code: 'EL', en: 'Estee Lauder', zh: '雅诗兰黛', sector: '消费', themes: ['美妆'], blurb: '雅诗兰黛，高端美妆' },
  { code: 'MDLZ', en: 'Mondelez', zh: '亿滋', sector: '消费', themes: ['食品'], blurb: '亿滋（奥利奥）' },
  { code: 'KHC', en: 'Kraft Heinz', zh: '卡夫亨氏', sector: '消费', themes: ['食品'], blurb: '卡夫亨氏，调料食品' },
  ...
  { code: 'ABNB', en: 'Airbnb', zh: 'Airbnb', sector: '消费', themes: ['旅游'], blurb: '民宿短租平台' },
  ...
  { code: 'NIO', en: 'NIO', zh: '蔚来', sector: '消费', themes: ['电动车'], blurb: '蔚来，换电模式' },
  { code: 'LI', en: 'Li Auto', zh: '理想', sector: '消费', themes: ['电动车'], blurb: '理想，增程SUV' },
  { code: 'XPEV', en: 'XPeng', zh: '小鹏', sector: '消费', themes: ['电动车'], blurb: '小鹏，智能驾驶激进' },
  { code: 'PDD', en: 'Pinduoduo', zh: '拼多多', sector: '消费', themes: ['电商'], blurb: '拼多多加Temu' },
  { code: 'JD', en: 'JD.com', zh: '京东', sector: '消费', themes: ['电商'], blurb: '京东，物流见长' },
  ...
  { code: 'VIPS', en: 'Vipshop', zh: '唯品会', sector: '消费', themes: ['电商'], blurb: '唯品会，特卖电商' },
  // ---- 医疗 ----
  { code: 'JNJ', en: 'Johnson & Johnson', zh: '强生', sector: '医疗', themes: ['医药'], blurb: '强生，医药加器械' },
  { code: 'LLY', en: 'Eli Lilly', zh: '礼来', sector: '医疗', themes: ['创新药'], blurb: '礼来，减肥药GLP-1龙头' },
  { code: 'UNH', en: 'UnitedHealth', zh: '联合健康', sector: '医疗', themes: ['保险'], blurb: '美国最大商业医保' },
  { code: 'PFE', en: 'Pfizer', zh: '辉瑞', sector: '医疗', themes: ['医药'], blurb: '辉瑞，新冠疫苗那家' },
  ...
  { code: 'ISRG', en: 'Intuitive Surgical', zh: '直觉外科', sector: '医疗', themes: ['医疗器械'], blurb: '达芬奇手术机器人' },
  ...
  { code: 'AMGN', en: 'Amgen', zh: '安进', sector: '医疗', themes: ['创新药'], blurb: '安进，生物药老牌' },
  ...
  { code: 'CVS', en: 'CVS Health', zh: 'CVS', sector: '医疗', themes: ['医药零售'], blurb: 'CVS，药房加医保' },
  { code: 'CI', en: 'Cigna', zh: '信诺', sector: '医疗', themes: ['保险'], blurb: '信诺，商业医保' },
  { code: 'HCA', en: 'HCA Healthcare', zh: 'HCA', sector: '医疗', themes: ['医院'], blurb: '美国最大连锁医院' },
  // ---- 能源 ----
  { code: 'XOM', en: 'Exxon Mobil', zh: '埃克森美孚', sector: '能源', themes: ['石油'], blurb: '埃克森美孚，石油巨头' },
  { code: 'CVX', en: 'Chevron', zh: '雪佛龙', sector: '能源', themes: ['石油'], blurb: '雪佛龙，石油巨头' },
  { code: 'COP', en: 'ConocoPhillips', zh: '康菲', sector: '能源', themes: ['石油'], blurb: '康菲，页岩油大户' },
  { code: 'EOG', en: 'EOG Resources', zh: 'EOG', sector: '能源', themes: ['石油'], blurb: '页岩油气，效率之王' },
  ...
  { code: 'PSX', en: 'Phillips 66', zh: '菲利普斯66', sector: '能源', themes: ['炼化'], blurb: '炼油加加油站' },
  { code: 'ENPH', en: 'Enphase', zh: 'Enphase', sector: '能源', themes: ['新能源'], blurb: '户用光伏逆变器' },
  { code: 'FSLR', en: 'First Solar', zh: 'First Solar', sector: '能源', themes: ['新能源'], blurb: '碲化镉薄膜光伏组件' },
  // ---- 工业 ----
  ...
  { code: 'DE', en: 'Deere', zh: '迪尔', sector: '工业', themes: ['机械'], blurb: '约翰迪尔，农机' },
  ...
  { code: 'UPS', en: 'UPS', zh: 'UPS', sector: '工业', themes: ['物流'], blurb: '快递' },
  { code: 'FDX', en: 'FedEx', zh: '联邦快递', sector: '工业', themes: ['物流'], blurb: '联邦快递' },
  ...
  { code: 'NOC', en: 'Northrop Grumman', zh: '诺格', sector: '工业', themes: ['军工'], blurb: '诺格，B21轰炸机' },
  ...
  { code: 'DAL', en: 'Delta Air Lines', zh: '达美航空', sector: '工业', themes: ['航空'], blurb: '达美航空' },
  { code: 'UAL', en: 'United Airlines', zh: '美联航', sector: '工业', themes: ['航空'], blurb: '美联航' },
  ...
  { code: 'EQIX', en: 'Equinix', zh: 'Equinix', sector: '房地产', themes: ['数据中心'], blurb: '数据中心REIT' },
  { code: 'DLR', en: 'Digital Realty', zh: 'Digital Realty', sector: '房地产', themes: ['数据中心'], blurb: '数据中心REIT' },
  { code: 'LIN', en: 'Linde', zh: '林德', sector: '原材料', themes: [], blurb: '林德，工业气体龙头' },
  { code: 'SHW', en: 'Sherwin-Williams', zh: '宣伟', sector: '原材料', themes: [], blurb: '宣伟，涂料' },
  { code: 'APD', en: 'Air Products', zh: '空气化工', sector: '原材料', themes: [], blurb: '空气化工，工业气体' },
  { code: 'FCX', en: 'Freeport-McMoRan', zh: '自由港', sector: '原材料', themes: ['铜'], blurb: '自由港，铜矿巨头' },
  { code: 'NEM', en: 'Newmont', zh: '纽蒙特', sector: '原材料', themes: ['黄金'], blurb: '纽蒙特，金矿龙头' },
  { code: 'GOLD', en: 'Barrick', zh: 'Barrick', sector: '原材料', themes: ['黄金'], blurb: 'Barrick，金矿' },
  // ---- 小众题材 ----
  { code: 'RCAT', en: 'Red Cat Holdings', zh: '红猫', sector: '工业', themes: ['无人机'], blurb: '红猫，军用小无人机' },
  ...
  { code: 'ASTS', en: 'AST SpaceMobile', zh: '星空移动', sector: '通信', themes: ['太空'], blurb: '天基手机直连卫星' },
  ...
  { code: 'IONQ', en: 'IonQ', zh: 'IonQ', sector: '科技', themes: ['量子'], blurb: '离子阱量子计算机' },
  { code: 'RGTI', en: 'Rigetti Computing', zh: 'Rigetti', sector: '科技', themes: ['量子'], blurb: '超导量子计算' },
