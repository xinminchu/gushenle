...
`,
  ...
  {
    version: "026_dice_drunk_game_id",
    name: "游戏战绩表：放宽 game_id 约束到 16 个游戏（含掷骰子/酒鬼走位）",
    sql: `-- 026_dice_drunk_game_id.sql
...
`,
  ...
  {
    version: "027_rosemary_review_adopted",
    name: "许愿池：采纳 @Rosemary 的掷骰子扩容评价，奖励 +20（合计 30）",
    sql: `-- 027_rosemary_review_adopted.sql
...
`,
  ...
  {
    version: "028_wish_claims",
    name: "许愿池昵称认领：wish_claims 认领申请表（+RLS）",
    sql: `-- 028_wish_claims.sql
